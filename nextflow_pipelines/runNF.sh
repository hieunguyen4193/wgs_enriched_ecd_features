...
while IFS=',' read -r INPUT_BED RUN_NAME; do \
    ...
    SAMPLE_SHEET="SampleSheet_BAM_highdepth_ExpressServer.csv";
    ...
    WORKDIR="/mnt/nvme/DATA_HIEUNGUYEN/outdir/TOO_enriched_features/workdir"/${RUN_NAME};
    mkdir -p $WORKDIR;

    PANDEPTH="/mnt/nvme/DATA_HIEUNGUYEN/resource/PanDepth/bin/pandepth";
    path_to_nucleosome_ref="/mnt/nvme/DATA_HIEUNGUYEN/resource/rpr_map_EXP0779.sorted.bed"
    nextflow run main.nf \
        ...
        --path_to_nucleosome_ref $path_to_nucleosome_ref \
